...
/* themes/goblac_adaptive/templates/form/field-multiple-value-form.html.twig */
class __TwigTemplate_43e7c387404fe7a3503820ffcf62e722 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 25)) {
                // line 26
                echo "      <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "attributes", [], "any", false, false, true, 26), "addClass", ["description"], "method", false, false, true, 26), 26, $this->source), "html", null, true);
                echo " >";
...
";
  ...
  ";
        ...
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["multiple", "table", "description", "button", "elements"]);    }
    ...
    {
        return "themes/goblac_adaptive/templates/form/field-multiple-value-form.html.twig";
    }
...
{% else %}
  ...
  {% endfor %}
{% endif %}
", "themes/goblac_adaptive/templates/form/field-multiple-value-form.html.twig", "/var/www/html/web/themes/goblac_adaptive/templates/form/field-multiple-value-form.html.twig");
    }
