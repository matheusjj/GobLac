...
class __TwigTemplate_f3987975bf33452b04c9eea18e734ce3 extends Template
{
    private $source;
    private $macros = [];
...
-%}
{%- if content -%}
  <div {{ attributes.addClass(classes) }} id=\"rid-{{ region|clean_id }}\">{{- content -}}</div>
{%- endif -%}
", "themes/goblac_adaptive/templates/layout/region.html.twig", "/var/www/html/web/themes/goblac_adaptive/templates/layout/region.html.twig");
    }
