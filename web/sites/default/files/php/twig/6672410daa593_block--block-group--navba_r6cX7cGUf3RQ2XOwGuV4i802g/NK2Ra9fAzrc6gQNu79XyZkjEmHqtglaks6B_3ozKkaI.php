...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        ";
        // line 53
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Drupal\Core\Template\DebugExtension::dump($this->env, $context, ...[$this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_sublink_link", [], "any", false, false, true, 53), 53, $this->source)]), "html", null, true);
        // line 54
  ...
  <div class=\"block__inner\">
    ...
    {%- block content -%}
      <div{{ content_attributes.addClass('block__content') }}>
        {{dump(content.field_sublink_link)}}
        {{- content -}}
      </div>
    {%- endblock -%}
