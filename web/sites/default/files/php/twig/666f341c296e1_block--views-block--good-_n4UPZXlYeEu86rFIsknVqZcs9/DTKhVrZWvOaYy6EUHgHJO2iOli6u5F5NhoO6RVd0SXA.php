...
/* themes/goblac_adaptive/templates/block/block--views-block--good-habits-view-home-search.html.twig */
class __TwigTemplate_3c9ef7b2f3ffb07a6ab1ea2888dd2278 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("block--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 37, $this->source)))) : ("")), "gh-view-block-search-home"];
        // line 41
...
";
    ...
    {
        return "themes/goblac_adaptive/templates/block/block--views-block--good-habits-view-home-search.html.twig";
    }
...
<div{{ attributes.addClass(classes)|without('role', 'aria-labelledby') }}{%- if label %} role=\"region\" aria-labelledby=\"{{ heading_id }}\"{%- endif -%}>
  <div class=\"block__inner\">
    ...
    {%- block content -%}
      <div{{ content_attributes.addClass('block__content main-content') }}>
        {{- content -}}
      </div>
    {%- endblock -%}
...
", "themes/goblac_adaptive/templates/block/block--views-block--good-habits-view-home-search.html.twig", "/var/www/html/web/themes/goblac_adaptive/templates/block/block--views-block--good-habits-view-home-search.html.twig");
    }
